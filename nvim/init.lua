...
require('lazy').setup({
  ...
  'tpope/vim-fugitive',
  {
    'tpope/vim-rhubarb',
    config = function()
      vim.keymap.set('v', 'go', ':GBrowse<CR>', { silent = true })
  ...
  { 'folke/which-key.nvim', opts = {} },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        vim.keymap.set('n', 'gu', require('gitsigns').reset_hunk)
      end,
    },
  },
...
require('telescope').setup {
  defaults = {
    mappings = {
      ...
      n = {
        ['<CR>'] = require "telescope.actions".select_tab,
        l = require "telescope.actions".select_tab,
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'kotlin', 'markdown', 'swift', 'dart', 'yaml' },
